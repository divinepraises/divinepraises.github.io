...
Some of the texts here might be copyrighted. We lay no claim on the texts, and if you are the rights owner and want them removed,

we'll gladly oblige. All the sources are indicated in the `about.html` file.
